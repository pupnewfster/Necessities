...
public class Listeners implements Listener {
	...
	public void foodLevelChange(FoodLevelChangeEvent e) {
		if(e.getEntity() instanceof Player) {
			User u = um.getUser(((Player) e.getEntity()).getUniqueId());
			if(u.godmode())
				e.setFoodLevel(20);
		}
	}
	...
	public void onPlayerMove(final PlayerMoveEvent e) {
		...
		Location to = e.getTo();
		locationChanged = Math.abs(from.getX() - to.getX()) > 0.1 || Math.abs(from.getY() - to.getY()) > 0.1 || Math.abs(from.getZ() - to.getZ()) > 0.1;
