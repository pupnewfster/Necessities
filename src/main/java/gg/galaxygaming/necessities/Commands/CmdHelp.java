                ...
                try {
                    ...
                    if (cmds != null)
                        for (String k : cmds.keySet()) {
                            ...
                            if (pc != null) {
                                if (p instanceof Necessities && !Necessities.getInstance().isCommandEnabled(pc.getName()))
                                    continue;
                    ...
                    if (cmds != null)
                        for (String k : cmds.keySet()) {
                            ...
                            if (pc != null) {
                                if (p instanceof Necessities && !Necessities.getInstance().isCommandEnabled(pc.getName()))
                                    continue;
                                if (isConsole || pc.testPermissionSilent(sender) && (pc.getName().toLowerCase().contains(search.toLowerCase()) || pc.getDescription().toLowerCase().contains(search.toLowerCase()))) {
                                    commands.add(var.getMessages() + "/" + pc.getName() + ChatColor.WHITE + ": " + pc.getDescription());
