        ...
        if (sender instanceof Player) {
            ...
            if (!p.hasPermission("Necessities.guilds.description")) {
                sender.sendMessage(var.getEr() + "Error: " + var.getErMsg()
                      + "You have not have permission to use /guild description.");
                return true;
            }
            ...
            if (u.getGuild() == null || u.getGuild().getRank(p.getUniqueId()) == null || u.getGuild()
                ...
                sender.sendMessage(var.getEr() + "Error: " + var.getErMsg()
                      + "You must be a mod or higher in your guild to change its description.");
                return true;
            }
            ...
            sender.sendMessage(var.getEr() + "Error: " + var.getErMsg()
                  + "You must be a player to change your guild's description.");
        }
        return true;
    }
}