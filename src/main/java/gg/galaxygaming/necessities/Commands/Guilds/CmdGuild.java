...
public class CmdGuild implements Cmd {
    ...
    public boolean commandUse(CommandSender sender, String[] args) {
        ...
        if (subCmd.equalsIgnoreCase("list")) {
            ...
            cmd = new CmdKick();
        } else if (subCmd.equalsIgnoreCase("mod") || subCmd.equalsIgnoreCase("officer") || subCmd
              .equalsIgnoreCase("moderator") || subCmd.equalsIgnoreCase("demod")) {
            cmd = new CmdMod();
            ...
            cmd = new CmdAlly();
        } else if (subCmd.equalsIgnoreCase("neutral") || subCmd.equalsIgnoreCase("unally") || subCmd
              .equalsIgnoreCase("unenemy")) {
            cmd = new CmdNeutral();
