...
public class CmdModifyWorld implements WorldCmd {
    ...
    public boolean commandUse(CommandSender sender, String[] args) {
        ...
        if (args.length < 3) {
            sender.sendMessage(var.getEr() + "Error: " + var.getErMsg()
                  + "Format requires you enter a world name a setting to modify and a value to change the setting to.");
            sender.sendMessage(var.getMessages() + "Valid settings are: " + ChatColor.WHITE
                  + "difficulty, gamemode, structures, pvp, animals, and monsters.");
            return true;
        }
        ...
        if (args[1].equalsIgnoreCase("difficulty")) {
            ...
            sender.sendMessage(
                  var.getMessages() + "Set difficulty to " + var.getObj() + dif.toString().toLowerCase() + var
                        .getMessages() + " in world " +
            ...
            sender.sendMessage(
                  var.getMessages() + "Set default gamemode in world " + var.getObj() + worldName + var.getMessages()
                        + " to " + var.getObj() +
            ...
            if (args[2].equalsIgnoreCase("true")) {
                ...
                sender.sendMessage(
                      var.getEr() + "Error: " + var.getErMsg() + "You must either enter true or false as the value.");
                return true;
            }
    ...
    private GameMode getGM(String message) {
        ...
        if (message.equalsIgnoreCase("creative") || message.equalsIgnoreCase("1") || message
