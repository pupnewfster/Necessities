...
public class CmdRename implements Cmd {
    public boolean commandUse(CommandSender sender, String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            player.sendMessage(var.getMessages() + "Successfully renamed your " + var.getObj() + gg.galaxygaming.necessities.Economy.Material.fromString(hand.getType().toString()).getFriendlyName() +
