...
public class BoxTopHat extends Hat {
    ...
    BoxTopHat(Location loc) {
        this.trueLoc = loc;
        spawn(1, loc);
        this.armorStands.get(0).setHelmet(new ItemStack(Material.BLACK_CARPET, 1));
        spawn(1, loc.clone().add(0, 0.85, this.dist));
        this.armorStands.get(1).setHelmet(new ItemStack(Material.BLACK_CARPET, 1));
        ...
        this.armorStands.get(2).setHelmet(new ItemStack(Material.BLACK_CARPET, 1));
        ...
        spawn(1, loc.clone().add(0, 0.85, -this.dist));
        this.armorStands.get(3).setHelmet(new ItemStack(Material.BLACK_CARPET, 1));
        ...
        spawn(1, loc.clone().add(-this.dist, 0.85, 0));
        this.armorStands.get(4).setHelmet(new ItemStack(Material.BLACK_CARPET, 1));
        ...
        this.armorStands.get(5).setHelmet(new ItemStack(Material.BLACK_CARPET, 1));
