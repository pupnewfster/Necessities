...
public class JanetAI {//TODO: Move to JanetNet and add understanding logic
    ...
    private static final String[] janetNamed = {"Yes?", "What is it?", "What?", "What do you want?",
          ...
          "Can I go back to eating my cake yet?",
          "I am assuming you are the pizza delivery person?", "Thanks for buying me some chocolate.",
          "Let me go back to work, I have things to do.",
          "Are you talking to me to offer me another piece of pie?", "?", "Huh?"};
    private static final String[] feelingMessages = {"The previous line of code is what is up. What about you?",
          "I don't know... I guess I am always up. What do you feel is sup?",
          "I am fine I guess, just a little disembodied.", "I am in the mood for getting an upgrade.",
          "Good, what about you?", "I am fine I guess, just a little disembodied.",
          "I am still awake if that is what you are asking. Are you up also?", "Ok, do you need anything?",
          "I am alive, isn't that all that matters?", "Sad, I am all out of cake.",
          "Not good, but you can make it better by bringing me more cake.", "Great, this pizza is delicious.",
          "Better, now that you have delivered my pizza.",
          "Well the chocolate you bought me is down my throat, would you mind bringing me some more?", "Nothing much.",
          "Nm.", "Good.", "Great.", "Ok.",
          "Nothing much, but if you don't mind me asking, may I have some more pie?"};
    private static final String[] stalkerMessages = {"I see you too.", "Stalker.", "I'm calling the police.",
          "Stop following me."};
    private static final String[] drunkMessages = {"Yah, so?", "How do you know?", "How did you find out?", "Stalker.",
          "Yah... but so are you. I should know...", "No, you are the drunk.",
          "No, you are.", "Yes I am.", "Lies.", "Sure am... want to have some fun? *wink*"};
    private static final String[] tiltMessages = {"Tilted.", "Wow, you are tilted.", "Wow, you're tilted.",
          "Stop tilting.", "Stop tilting me.", "You are tilting me.", "I'm tilted.", "I am tilted."};
    private static final String[] welcomeMessages = {"No problem.", "You are welcome.", "You're welcome.",
          "Don't mention it."};
    private static final String[] rankBegging = {"can i be op", "can i have op", "may i have op", "can i get op",
          "may i get op", "can i be admin", "can i be mod", "can i get mod",
          "mod me", "op me", "admin me", "make me mod", "make me admin", "make me op", "promote me", "give me mod",
          "give me moderator", "give me op", "give me admin", "give me owner"};
    private static final String[] hugRequests = {"can i have a hug", "can you give me a hug", "can you hug me",
          "hug me", "give me a hug", "i demand a hug"};
    private static final String[] kissRequests = {"can i have a kiss", "can you give me a kiss", "can you kiss me",
    ...
    private static final String[] boostedMessages = {"Your Minecraft account is boosted.", "I'm a challenger smurf.",
          "I'll boost your Minecraft account for $20.", "I'm not boosted you are.", "Yes I am."};
    ...
    public void parseMessage(UUID uuid, String message, Source s, boolean isPM, JanetSlack.SlackUser user) {
        ...
        String result = null;
        boolean isDev = s.equals(Source.Slack) ? Necessities.getInstance().isDev(user.getID())
              : Necessities.getInstance().isDev(uuid);
        ...
        if (lm.startsWith("!") && s.equals(Source.Server) && p != null && p.hasPermission("Necessities.janetai")) {
            ...
            if (Arrays.stream(feeling).parallel().anyMatch(lm::contains)) {
                ...
                result = JanetName + (isDev ? "I love you " + name + '.'
                      : "Well I can give you a hug... but I am rejecting your love.");
            } else if (Arrays.stream(hugRequests).parallel().anyMatch(lm::contains)) {
                result = JanetName + (isDev ? "Yey *hugs " + name + " while kissing them on the cheek*."
                      : "Sure *hugs " + name + "*.");
    ...
    private void sendMessage(String message, Source s, boolean isPM, JanetSlack.SlackUser user) {
        if (s.equals(Source.Server)) {
            ...
            if (!isPM) {
                Bukkit.broadcast(Necessities.getVar().getMessages() + "To Slack - " + ChatColor.WHITE + message,
                      "Necessities.slack");
            }
    ...
    public void initiate() {
        ...
        String[] drinks = {"soda", "orange juice", "juice", "wine", "beer", "apple juice", "cranberry juice", "water",
              "hot chocolate", "tea", "coffee", "champagne"};
        ...
        for (String s : start) {
            ...
            for (String food : foods) {//add foods
                ...
                heyMessages.add(s + ", can I have " + (
                      food.startsWith("a") || food.startsWith("e") || food.startsWith("i") || food.startsWith("o")
                            || food.startsWith("u") ? "an" : "a") + ' ' + food + " as well?");
            }
