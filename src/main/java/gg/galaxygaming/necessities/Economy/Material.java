...
public enum Material {//http://minecraft.gamepedia.com/Id
    ...
    PLANKS("PLANKS", org.bukkit.Material.LEGACY_WOOD, "PLANKS", 5, "PLANK", Arrays.asList("WOOD", "PLANK")),
    ...
    SAPLING("SAPLING", org.bukkit.Material.LEGACY_SAPLING, "SAPLINGS", 6),
    ...
    WATER("WATER", org.bukkit.Material.WATER, 8),
    LAVA("LAVA", org.bukkit.Material.LAVA, 10),
    ...
    LOG("LOG", org.bukkit.Material.LEGACY_LOG, "LOGS", 17, Collections.singletonList("BARK")),
    ...
    LEAVES("LEAVES", org.bukkit.Material.LEGACY_LEAVES, 18),
    ...
    BED_BLOCK("BED_BLOCK", org.bukkit.Material.LEGACY_BED_BLOCK, 26),//Unobtainable
    ...
    STICKY_PISTON("STICKY_PISTON", org.bukkit.Material.LEGACY_PISTON_STICKY_BASE, "STICKY PISTONS", 29, Collections.singletonList("PISTON_STICKY_BASE")),
    WEB("WEB", org.bukkit.Material.COBWEB, "COBWEBS", 30, "COBWEB", Arrays.asList("COBWEB", "SPIDER_WEB")),
    TALLGRASS("TALLGRASS", org.bukkit.Material.TALL_GRASS, 31, Collections.singletonList("LONG_GRASS")),
    ...
    PISTON("PISTON", org.bukkit.Material.LEGACY_PISTON_BASE, "PISTONS", 33, Collections.singletonList("PISTON_BASE")),
    PISTON_HEAD("PISTON_HEAD", org.bukkit.Material.LEGACY_PISTON_MOVING_PIECE, 34, Collections.singletonList("PISTON_MOVING_PIECE")),//Unobtainable
    WOOL("WOOL", org.bukkit.Material.LEGACY_WOOL, 35),
    ...
    PISTON_EXTENSION("PISTON_EXTENSION", org.bukkit.Material.LEGACY_PISTON_EXTENSION, 36),//Unobtainable
    YELLOW_FLOWER("YELLOW_FLOWER", org.bukkit.Material.DANDELION, "DANDELIONS", 37, "DANDELION", Collections.singletonList("DANDELION")),
    RED_FLOWER("RED_FLOWER", org.bukkit.Material.POPPY, 38),
    ...
    DOUBLE_STONE_SLAB("DOUBLE_STONE_SLAB", org.bukkit.Material.LEGACY_DOUBLE_STEP, "DOUBLE STONE SLABS", 43, Collections.singletonList("DOUBLE_STEP")),//Unobtainable
    ...
    STONE_SLAB("STONE_SLAB", org.bukkit.Material.LEGACY_STEP, "STONE SLABS", 44, Arrays.asList("SLAB", "STEP")),
    ...
    MOB_SPAWNER("MOB_SPAWNER", org.bukkit.Material.SPAWNER, "MONSTER SPAWNERS", 52, "MONSTER SPAWNER", Arrays.asList("SPAWNER", "MONSTER_SPAWNER")),
    ...
    OAK_STAIRS("OAK_STAIRS", org.bukkit.Material.OAK_STAIRS, "OAK STAIRS", 53, "OAK STAIR", Collections.singletonList("WOOD_STAIRS")),
    ...
    CRAFTING_TABLE("CRAFTING_TABLE", org.bukkit.Material.CRAFTING_TABLE, "CRAFTING TABLES", 58, Collections.singletonList("WORKBENCH")),
    WHEAT_BLOCK("WHEAT_BLOCK", org.bukkit.Material.LEGACY_CROPS, 59, "CROPS", Collections.singletonList("CROPS")),//Unobtainable
    ...
    FARMLAND("FARMLAND", org.bukkit.Material.FARMLAND, 60, Arrays.asList("SOIL", "TILLED_SOIL", "TILLED_GROUND", "TILLED_LAND")),
    ...
    LIT_FURNACE("LIT_FURNACE", org.bukkit.Material.LEGACY_BURNING_FURNACE, "BURNING FURNACES", 62, "BURNING FURNACE", Collections.singletonList("BURNING_FURNACE")),
    STANDING_SIGN("STANDING_SIGN", org.bukkit.Material.LEGACY_SIGN_POST, 63, Collections.singletonList("SIGN_POST")),//Unobtainable
    WOODEN_DOOR_BLOCK("WOODEN_DOOR_BLOCK", org.bukkit.Material.LEGACY_WOODEN_DOOR, 64),//Unobtainable
    LADDER("LADDER", org.bukkit.Material.LADDER, "LADDERS", 65),
    RAIL("RAIL", org.bukkit.Material.RAIL, "RAILS", 66, Collections.singletonList("RAILS")),
    ...
    WALL_SIGN("WALL_SIGN", org.bukkit.Material.WALL_SIGN, 68),//Unobtainable
    LEVER("LEVER", org.bukkit.Material.LEVER, "LEVERS", 69),
    STONE_PRESSURE_PLATE("STONE_PRESSURE_PLATE", org.bukkit.Material.STONE_PRESSURE_PLATE, "STONE PRESSURE PLATES", 70, Arrays.asList("PRESSURE_PLATE", "STONE_PLATE")),
    IRON_DOOR_BLOCK("IRON_DOOR_BLOCK", org.bukkit.Material.LEGACY_IRON_DOOR_BLOCK, 71),//Unobtainable
    WOODEN_PRESSURE_PLATE("WOODEN_PRESSURE_PLATE", org.bukkit.Material.LEGACY_WOOD_PLATE, "WOODEN PRESSURE PLATES", 72, Arrays.asList("WOOD_PRESSURE_PLATE", "WOODEN_PLATE", "WOOD_PLATE")),
    REDSTONE_ORE("REDSTONE_ORE", org.bukkit.Material.REDSTONE_ORE, 73),
    LIT_REDSTONE_ORE("LIT_REDSTONE_ORE", org.bukkit.Material.LEGACY_GLOWING_REDSTONE_ORE, 74, Collections.singletonList("GLOWING_REDSTONE_ORE")),//Unobtainable
    UNLIT_REDSTONE_TORCH("UNLIT_REDSTONE_TORCH", org.bukkit.Material.LEGACY_REDSTONE_TORCH_OFF, 75, Collections.singletonList("REDSTONE_TORCH_OFF")),//Unobtainable
    ...
    REDSTONE_TORCH("REDSTONE_TORCH", org.bukkit.Material.LEGACY_REDSTONE_TORCH_ON, "REDSTONE TORCHES", 76, Arrays.asList("LIT_REDSTONE_TORCH", "REDSTONE_TORCH_ON")),
    ...
    REEDS_BLOCK("REEDS_BLOCK", org.bukkit.Material.LEGACY_SUGAR_CANE_BLOCK, 83, Collections.singletonList("SUGAR_CANE_BLOCK")),//Unobtainable
    JUKEBOX("JUKEBOX", org.bukkit.Material.JUKEBOX, 84),
    JUKEBOX_WITH_DISK("JUKEBOX_WITH_DISK", JUKEBOX, (short) 1),
    FENCE("FENCE", org.bukkit.Material.LEGACY_FENCE, "FENCES", 85),
    ...
    PORTAL("PORTAL", org.bukkit.Material.NETHER_PORTAL, "PORTALS", 90, Collections.singletonList("NETHER_PORTAL")),//Unobtainable
    ...
    CAKE_BLOCK("CAKE_BLOCK", org.bukkit.Material.LEGACY_CAKE_BLOCK, 92),//Unobtainable
    ...
    UNPOWERED_REPEATER("UNPOWERED_REPEATER", org.bukkit.Material.LEGACY_DIODE_BLOCK_OFF, 93, Collections.singletonList("DIODE_BLOCK_OFF")),//Unobtainable
    POWERED_REPEATER("POWERED_REPEATER", org.bukkit.Material.LEGACY_DIODE_BLOCK_ON, 94, Collections.singletonList("DIODE_BLOCK_ON")),//Unobtainable
    STAINED_GLASS("STAINED_GLASS", org.bukkit.Material.LEGACY_STAINED_GLASS, 95, Collections.singletonList("TINTED_GLASS")),
    ...
    TRAPDOOR("TRAPDOOR", org.bukkit.Material.LEGACY_TRAP_DOOR, "TRAP DOORS", 96, "TRAP DOOR"),
    MONSTER_EGG("MONSTER_EGG", org.bukkit.Material.LEGACY_MONSTER_EGGS, "MONSTER EGGS", 97, Collections.singletonList("MONSTER_EGGS")),
    ...
    STONEBRICK("STONEBRICK", org.bukkit.Material.STONE_BRICKS, "STONE BRICKS", 98, "STONE BRICK", Collections.singletonList("SMOOTH_BRICK")),
    ...
    BROWN_MUSHROOM_BLOCK("BROWN_MUSHROOM_BLOCK", org.bukkit.Material.LEGACY_HUGE_MUSHROOM_1, "BROWN MUSHROOM BLOCKS", 99, Collections.singletonList("HUGE_MUSHROOM_1")),
    ...
    RED_MUSHROOM_BLOCK("RED_MUSHROOM_BLOCK", org.bukkit.Material.LEGACY_HUGE_MUSHROOM_2, "RED MUSHROOM BLOCKS", 100, Collections.singletonList("HUGE_MUSHROOM_2")),
    ...
    IRON_BARS("IRON_BARS", org.bukkit.Material.IRON_BARS, "IRON BARS", 101, "IRON BAR", Collections.singletonList("IRON_FENCE")),
    GLASS_PANE("GLASS_PANE", org.bukkit.Material.GLASS_PANE, "GLASS PANES", 102, Collections.singletonList("THIN_GLASS")),
    MELON_BLOCK("MELON_BLOCK", org.bukkit.Material.LEGACY_MELON_BLOCK, "MELON BLOCKS", 103),
    ...
    FENCE_GATE("FENCE_GATE", org.bukkit.Material.LEGACY_FENCE_GATE, "FENCE GATES", 107),
    BRICK_STAIRS("BRICK_STAIRS", org.bukkit.Material.BRICK_STAIRS, "BRICK STAIRS", 108, "BRICK STAIR"),
    STONE_BRICK_STAIRS("STONE_BRICK_STAIRS", org.bukkit.Material.STONE_BRICK_STAIRS, "STONE BRICK STAIRS", 109, "STONE BRICK STAIR", Collections.singletonList("SMOOTH_STAIRS")),
    MYCELIUM("MYCELIUM", org.bukkit.Material.MYCELIUM, 110, Collections.singletonList("MYCEL")),
    WATERLILY("WATERLILY", org.bukkit.Material.LILY_PAD, "LILY PADS", 111, "LILY PAD", Collections.singletonList("LILY_PAD")),
    NETHER_BRICK_BLOCK("NETHER_BRICK_BLOCK", org.bukkit.Material.NETHER_BRICK, "NETHER BRICK BLOCKS", 112),
    NETHER_BRICK_FENCE("NETHER_BRICK_FENCE", org.bukkit.Material.NETHER_BRICK_FENCE, "NETHER BRICK FENCES", 113, Collections.singletonList("NETHER_FENCE")),
    ...
    NETHER_WART_STALK("NETHER_WART_STALK", org.bukkit.Material.LEGACY_NETHER_WARTS, 115, Collections.singletonList("NETHER_WARTS")),//Unobtainable
    ...
    ENCHANTING_TABLE("ENCHANTING_TABLE", org.bukkit.Material.ENCHANTING_TABLE, "ENCHANTMENT TABLES", 116, "ENCHANTMENT TABLE", Arrays.asList("ENCHANTMENT_TABLE", "ENCHANT_TABLE")),
    END_PORTAL("END_PORTAL", org.bukkit.Material.END_PORTAL, "END PORTALS", 119, Collections.singletonList("ENDER_PORTAL")),//Unobtainable
    END_PORTAL_FRAME("END_PORTAL_FRAME", org.bukkit.Material.END_PORTAL_FRAME, "END PORTAL FRAMES", 120, Collections.singletonList("ENDER_PORTAL_FRAME")),
    ...
    END_STONE("END_STONE", org.bukkit.Material.END_STONE, 121, Collections.singletonList("ENDER_STONE")),
    DRAGON_EGG("DRAGON_EGG", org.bukkit.Material.DRAGON_EGG, "DRAGON EGGS", 122, Arrays.asList("ENDER_DRAGON_EGG", "END_DRAGON_EGG")),
    REDSTONE_LAMP("REDSTONE_LAMP", org.bukkit.Material.LEGACY_REDSTONE_LAMP_OFF, "REDSTONE LAMPS", 123, Arrays.asList("LAMP", "REDSTONE_LAMP_OFF", "LAMP_OFF")),
    LIT_REDSTONE_LAMP("LIT_REDSTONE_LAMP", org.bukkit.Material.LEGACY_REDSTONE_LAMP_ON, 124, Collections.singletonList("REDSTONE_LAMP_ON")),//Unobtainable
    DOUBLE_WOODEN_SLAB("DOUBLE_WOODEN_SLAB", org.bukkit.Material.LEGACY_WOOD_DOUBLE_STEP, 125, Collections.singletonList("WOOD_DOUBLE_STEP")),//Unobtainable
    ...
    WOODEN_SLAB("WOODEN_SLAB", org.bukkit.Material.LEGACY_WOOD_STEP, "WOODEN_SLABS", 126, Arrays.asList("WOODEN_STEP", "WOOD_STEP", "WOOD_SLAB")),
    ...
    SPRUCE_STAIRS("SPRUCE_STAIRS", org.bukkit.Material.SPRUCE_STAIRS, "SPRUCE STAIRS", 134, "SPRUCE STAIR", Collections.singletonList("SPRUCE_WOOD_STAIRS")),
    BIRCH_STAIRS("BIRCH_STAIRS", org.bukkit.Material.BIRCH_STAIRS, "BIRCH STAIRS", 135, "BIRCH STAIR", Collections.singletonList("BIRCH_WOOD_STAIRS")),
    JUNGLE_STAIRS("JUNGLE_STAIRS", org.bukkit.Material.JUNGLE_STAIRS, "JUNGLE STAIRS", 136, "JUNGLE STAIR", Collections.singletonList("JUNGLE_WOOD_STAIRS")),
    COMMAND_BLOCK("COMMAND_BLOCK", org.bukkit.Material.COMMAND_BLOCK, 137, Collections.singletonList("COMMAND")),
    BEACON("BEACON", org.bukkit.Material.BEACON, "BEACONS", 138),
    COBBLESTONE_WALL("COBBLESTONE_WALL", org.bukkit.Material.COBBLESTONE_WALL, "COBBLESTONE WALLS", 139, Collections.singletonList("COBBLE_WALL")),
    ...
    WOODEN_BUTTON("WOODEN_BUTTON", org.bukkit.Material.LEGACY_WOOD_BUTTON, 143, Collections.singletonList("WOOD_BUTTON")),
    SKULL_BLOCK("SKULL_BLOCK", org.bukkit.Material.LEGACY_SKULL, 144),//Unobtainable
    ...
    LIGHT_WEIGHTED_PRESSURE_PLATE("LIGHT_WEIGHTED_PRESSURE_PLATE", org.bukkit.Material.LIGHT_WEIGHTED_PRESSURE_PLATE, "WEIGHTED LIGHT PRESSURE PLATES", 147, "WEIGHTED LIGHT PRESSURE PLATE", Arrays.asList("GOLD_PLATE", "GOLD_PRESSURE_PLATE", "LIGHT_PRESSURE_PLATE", "GOLDEN_PLATE", "GOLDEN_PRESSURE_PLATE", "WEIGHTED_LIGHT_PRESSURE_PLATE")),
    HEAVY_WEIGHTED_PRESSURE_PLATE("HEAVY_WEIGHTED_PRESSURE_PLATE", org.bukkit.Material.HEAVY_WEIGHTED_PRESSURE_PLATE, "WEIGHTED HEAVY PRESSURE PLATES", 148, "WEIGHTED HEAVY PRESSURE PLATE", Arrays.asList("HEAVY_PRESSURE_PLATE", "IRON_PLATE", "IRON_PRESSURE_PLATE", "WEIGHTED_HEAVY_PRESSURE_PLATE")),
    UNPOWERED_COMPARATOR("UNPOWERED_COMPARATOR", org.bukkit.Material.LEGACY_REDSTONE_COMPARATOR_OFF, 149, Collections.singletonList("REDSTONE_COMPARATOR_OFF")),//Unobtainable
    POWERED_COMPARATOR("POWERED_COMPARATOR", org.bukkit.Material.LEGACY_REDSTONE_COMPARATOR_ON, 150, Collections.singletonList("REDSTONE_COMPARATOR_ON")),//Unobtainable
    ...
    QUARTZ_ORE("QUARTZ_ORE", org.bukkit.Material.NETHER_QUARTZ_ORE, 153, Collections.singletonList("NETHER_QUARTZ_ORE")),
    ...
    STAINED_HARDENED_CLAY("STAINED_HARDENED_CLAY", org.bukkit.Material.LEGACY_STAINED_CLAY, 159, Arrays.asList("STAINED_HARD_CLAY", "STAINED_CLAY", "STAINED_TERRACOTTA")),
    ...
    STAINED_GLASS_PANE("STAINED_GLASS_PANE", org.bukkit.Material.LEGACY_STAINED_GLASS_PANE, 160, Arrays.asList("TINTED_GLASS_PANE", "TINTED_THIN_GLASS", "STAINED_THIN_GLASS")),
    ...
    LEAVES2("LEAVES2", org.bukkit.Material.LEGACY_LEAVES_2, 161),
    ...
    LOG2("LOG2", org.bukkit.Material.LEGACY_LOG_2, 162),
    ...
    CARPET("CARPET", org.bukkit.Material.LEGACY_CARPET, "CARPETS", 171),
    ...
    HARDENED_CLAY("HARDENED_CLAY", org.bukkit.Material.TERRACOTTA, 172, "TERRACOTTA", Arrays.asList("HARD_CLAY", "TERRACOTTA")),
    ...
    DOUBLE_PLANT("DOUBLE_PLANT", org.bukkit.Material.LEGACY_DOUBLE_PLANT, 175),
    ...
    STANDING_BANNER("STANDING_BANNER", org.bukkit.Material.LEGACY_STANDING_BANNER, 176),//Unobtainable
    ...
    WALL_BANNER("WALL_BANNER", org.bukkit.Material.LEGACY_WALL_BANNER, 177),//Unobtainable
    ...
    DOUBLE_STONE_SLAB2("DOUBLE_STONE_SLAB2", org.bukkit.Material.LEGACY_DOUBLE_STONE_SLAB2, 181),//Unobtainable
    ...
    STONE_SLAB2("STONE_SLAB2", org.bukkit.Material.LEGACY_STONE_SLAB2, 182),
    ...
    PURPUR_DOUBLE_SLAB("PURPUR_DOUBLE_SLAB", org.bukkit.Material.LEGACY_PURPUR_DOUBLE_SLAB, "DOUBLE PURPUR SLABS", 204, "DOUBLE PURPUR SLAB", Collections.singletonList("DOUBLE_PURPUR_SLAB")),
    PURPUR_SLAB("PURPUR_SLAB", org.bukkit.Material.PURPUR_SLAB, "PURPUR SLABS", 205, Collections.singletonList("PURPUR_STEP")),
    END_BRICKS("END_BRICKS", org.bukkit.Material.END_STONE_BRICKS, "END STONE BRICKS", 206, "END STONE BRICK", Arrays.asList("END_STONE_BRICKS", "ENDER_BRICKS", "ENDER_STONE_BRICKS")),
    BEETROOTS("BEETROOTS", org.bukkit.Material.LEGACY_BEETROOT_BLOCK, 207, Collections.singletonList("BEETROOT_BLOCK")),//Unobtainable
    ...
    REPEATING_COMMAND_BLOCK("REPEATING_COMMAND_BLOCK", org.bukkit.Material.REPEATING_COMMAND_BLOCK, "REPEATING COMMAND BLOCKS", 210, Arrays.asList("COMMAND_REPEATING", "COMMAND_BLOCK_REPEATING", "REPEATING_COMMAND")),
    CHAIN_COMMAND_BLOCK("CHAIN_COMMAND_BLOCK", org.bukkit.Material.CHAIN_COMMAND_BLOCK, "CHAIN COMMAND BLOCKS", 211, Arrays.asList("COMMAND_CHAIN", "CHAIN_COMMAND", "COMMAND_BLOCK_CHAIN")),
    FROSTED_ICE("FROSTED_ICE", org.bukkit.Material.FROSTED_ICE, 212),//Unobtainable
    MAGMA("MAGMA", org.bukkit.Material.MAGMA_BLOCK, "MAGMA BLOCKS", 213, "MAGMA BLOCK", Collections.singletonList("MAGMA_BLOCK")),
    NETHER_WART_BLOCK("NETHER_WART_BLOCK", org.bukkit.Material.NETHER_WART_BLOCK, "NETHER WART BLOCKS", 214),
    RED_NETHER_BRICK("RED_NETHER_BRICK", org.bukkit.Material.LEGACY_RED_NETHER_BRICK, "RED NETHER BRICKS", 215),
    ...
    LIGHT_GRAY_SHULKER_BOX("LIGHT_GRAY_SHULKER_BOX", org.bukkit.Material.LIGHT_GRAY_SHULKER_BOX, "LIGHT GRAY SHULKER BOXES", 227, Collections.singletonList("SILVER_SHULKER_BOX")),
    ...
    LIGHT_GRAY_GLAZED_TERRACOTTA("LIGHT_GRAY_GLAZED_TERRACOTTA", org.bukkit.Material.LIGHT_GRAY_GLAZED_TERRACOTTA, 243, Collections.singletonList("SILVER_GLAZED_TERRACOTTA")),
    ...
    CONCRETE("CONCRETE", org.bukkit.Material.LEGACY_CONCRETE, 251),
    ...
    CONCRETE_POWDER("CONCRETE_POWDER", org.bukkit.Material.LEGACY_CONCRETE_POWDER, 252, Arrays.asList("CEMENT", "CONCRETE_DUST")),
    ...
    //ITEM IDS
    IRON_SHOVEL("IRON_SHOVEL", org.bukkit.Material.IRON_SHOVEL, "IRON SHOVELS", 256, Collections.singletonList("IRON_SPADE")),
    ...
    WOODEN_SWORD("WOODEN_SWORD", org.bukkit.Material.WOODEN_SWORD, "WOODEN SWORDS", 268, Collections.singletonList("WOOD_SWORD")),
    WOODEN_SHOVEL("WOODEN_SHOVEL", org.bukkit.Material.WOODEN_SHOVEL, "WOODEN SHOVELS", 269, Arrays.asList("WOOD_SHOVEL", "WOODEN_SPADE", "WOOD_SPADE")),
    WOODEN_PICKAXE("WOODEN_PICKAXE", org.bukkit.Material.WOODEN_PICKAXE, "WOODEN PICKAXES", 270, Arrays.asList("WOOD_PICKAXE", "WOOD_PICK")),
    WOODEN_AXE("WOODEN_AXE", org.bukkit.Material.WOODEN_AXE, "WOODEN AXES", 271, Collections.singletonList("WOOD_AXE")),
    STONE_SWORD("STONE_SWORD", org.bukkit.Material.STONE_SWORD, "STONE SWORDS", 272),
    STONE_SHOVEL("STONE_SHOVEL", org.bukkit.Material.STONE_SHOVEL, "STONE SHOVELS", 273, Collections.singletonList("STONE_SPADE")),
    ...
    DIAMOND_SHOVEL("DIAMOND_SHOVEL", org.bukkit.Material.DIAMOND_SHOVEL, "DIAMOND SHOVELS", 277, Collections.singletonList("DIAMOND_SPADE")),
    ...
    MUSHROOM_STEW("MUSHROOM_STEW", org.bukkit.Material.MUSHROOM_STEW, 282, Collections.singletonList("MUSHROOM_SOUP")),
    GOLDEN_SWORD("GOLDEN_SWORD", org.bukkit.Material.GOLDEN_SWORD, "GOLDEN SWORDS", 283, Collections.singletonList("GOLD_SWORD")),
    GOLDEN_SHOVEL("GOLDEN_SHOVEL", org.bukkit.Material.GOLDEN_SHOVEL, "GOLDEN SHOVELS", 284, Arrays.asList("GOLD_SHOVEL", "GOLD_SPADE", "GOLDEN_SPADE")),
    GOLDEN_PICKAXE("GOLDEN_PICKAXE", org.bukkit.Material.GOLDEN_PICKAXE, "GOLDEN PICKAXES", 285, Arrays.asList("GOLDEN_PICK", "GOLD_PICKAXE", "GOLD_PICK")),
    GOLDEN_AXE("GOLDEN_AXE", org.bukkit.Material.GOLDEN_AXE, "GOLDEN AXES", 286, Collections.singletonList("GOLD_AXE")),
    STRING("STRING", org.bukkit.Material.STRING, 287),
    FEATHER("FEATHER", org.bukkit.Material.FEATHER, "FEATHERS", 288),
    GUNPOWDER("GUNPOWDER", org.bukkit.Material.GUNPOWDER, 289, Collections.singletonList("SULPHUR")),
    WOODEN_HOE("WOODEN_HOE", org.bukkit.Material.WOODEN_HOE, "WOODEN HOES", 290, Collections.singletonList("WOOD_HOE")),
    ...
    GOLDEN_HOE("GOLDEN_HOE", org.bukkit.Material.GOLDEN_HOE, "GOLDEN HOES", 294, Collections.singletonList("GOLD_HOE")),
    WHEAT_SEEDS("WHEAT_SEEDS", org.bukkit.Material.WHEAT_SEEDS, "SEEDS", 295, "SEED", Collections.singletonList("SEEDS")),
    ...
    GOLDEN_HELMET("GOLDEN_HELMET", org.bukkit.Material.GOLDEN_HELMET, "GOLDEN HELMETS", 314, Arrays.asList("GOLDEN_HAT", "GOLD_HELMET", "GOLD_HAT")),
    GOLDEN_CHESTPLATE("GOLDEN_CHESTPLATE", org.bukkit.Material.GOLDEN_CHESTPLATE, "GOLDEN CHESTPLATES", 315, Arrays.asList("GOLDEN_CHEST", "GOLD_CHEST", "GOLD_CHESTPLATE", "GOLDEN_SHIRT", "GOLD_SHIRT")),
    GOLDEN_LEGGINGS("GOLDEN_LEGGINGS", org.bukkit.Material.GOLDEN_LEGGINGS, "GOLDEN LEGGINGS", 316, "GOLDEN LEGGING", Arrays.asList("GOLDEN_PANTS", "GOLD_PANTS", "GOLD_LEGGINGS")),
    GOLDEN_BOOTS("GOLDEN_BOOTS", org.bukkit.Material.GOLDEN_BOOTS, "GOLDEN BOOTS", 317, "GOLDEN BOOT", Arrays.asList("GOLD_BOOTS", "GOLD_SHOES", "GOLDEN_SHOES")),
    FLINT("FLINT", org.bukkit.Material.FLINT, 318),
    PORKCHOP("PORKCHOP", org.bukkit.Material.PORKCHOP, "RAW PORKCHOPS", 319, "RAW PORKCHOP", Arrays.asList("PORK", "RAW_PORK", "RAW_PORKCHOP")),
    COOKED_PORKCHOP("COOKED_PORKCHOP", org.bukkit.Material.COOKED_PORKCHOP, "COOKED PORKCHOPS", 320, Arrays.asList("GRILLED_PORK", "GRILLED_PORKCHOP", "COOKED_PORK")),
    ...
    WOODEN_DOOR("WOODEN_DOOR", org.bukkit.Material.OAK_DOOR, "OAK DOORS", 324, "OAK DOOR", Arrays.asList("WOOD_DOOR", "OAK_DOOR")),
    ...
    SNOWBALL("SNOWBALL", org.bukkit.Material.SNOWBALL, "SNOWBALLS", 332),
    BOAT("BOAT", org.bukkit.Material.OAK_BOAT, "OAK BOATS", 333, "OAK BOAT", Collections.singletonList("OAK_BOAT")),
    ...
    BRICK("BRICK", org.bukkit.Material.LEGACY_CLAY_BRICK, "BRICKS", 336, Collections.singletonList("CLAY_BRICK")),
    ...
    CHEST_MINECART("CHEST_MINECART", org.bukkit.Material.CHEST_MINECART, "MINECARTS WITH CHESTS", 342, "MINECART WITH CHEST", Collections.singletonList("STORAGE_MINECART")),
    FURNACE_MINECART("FURNACE_MINECART", org.bukkit.Material.FURNACE_MINECART, "MINECARTS WITH FURNACES", 343, "MINECART WITH FURNACE", Collections.singletonList("POWERED_MINECART")),
    ...
    CLOCK("CLOCK", org.bukkit.Material.CLOCK, "CLOCKS", 347, Collections.singletonList("WATCH")),
    GLOWSTONE_DUST("GLOWSTONE_DUST", org.bukkit.Material.GLOWSTONE_DUST, 348),
    FISH("FISH", org.bukkit.Material.LEGACY_RAW_FISH, 349, Collections.singletonList("RAW_FISH")),
    SALMON("SALMON", FISH, (short) 1),
    CLOWNFISH("CLOWNFISH", FISH, (short) 2),
    PUFFERFISH("PUFFERFISH", FISH, (short) 3),
    COOKED_FISH("COOKED_FISH", org.bukkit.Material.LEGACY_COOKED_FISH, 350),
    COOKED_SALMON("COOKED_SALMON", COOKED_FISH, (short) 1),
    DYE("DYE", org.bukkit.Material.INK_SAC, 351),
    INK_SACK("INK_SACK", DYE, (short) 0, Collections.singletonList("INK_SAC")),
    ...
    BED("BED", org.bukkit.Material.LEGACY_BED, "BEDS", 355),
    ...
    REPEATER("REPEATER", org.bukkit.Material.REPEATER, "REDSTONE REPEATERS", 356, "REDSTONE REPEATER", Arrays.asList("DIODE", "REDSTONE_REPEATER")),
    ...
    BEEF("BEEF", org.bukkit.Material.BEEF, 363, Arrays.asList("RAW_STEAK", "RAW_BEEF")),
    COOKED_BEEF("COOKED_BEEF", org.bukkit.Material.COOKED_BEEF, "STEAKS", 364, "STEAK", Collections.singletonList("STEAK")),
    CHICKEN("CHICKEN", org.bukkit.Material.CHICKEN, 365, Collections.singletonList("RAW_CHICKEN")),
    ...
    NETHER_WART("NETHER_WART", org.bukkit.Material.LEGACY_NETHER_STALK, "NETHER WARTS", 372, Arrays.asList("WART", "NETHER_STALK")),
    ...
    BREWING_STAND("BREWING_STAND", org.bukkit.Material.BREWING_STAND, "BREWING STANDS", 379, Arrays.asList("BREWING_STAND_ITEM", "BREWING_STAND_BLOCK")),
    CAULDRON("CAULDRON", org.bukkit.Material.CAULDRON, "CAULDRONS", 380, Arrays.asList("CAULDRON_ITEM", "CAULDRON_BLOCK")),
    ENDER_EYE("ENDER_EYE", org.bukkit.Material.ENDER_EYE, "EYES OF ENDER", 381, "EYE OF ENDER", Collections.singletonList("EYE_OF_ENDER")),
    SPECKLED_MELON("SPECKLED_MELON", org.bukkit.Material.GLISTERING_MELON_SLICE, "GLISTERING MELONS", 382, "GLISTERING MELON", Arrays.asList("GLISTERING_MELON", "GLISTERING_MELON_SLICE", "SPECKLED_MELON_SLICE")),
    SPAWN_EGG("SPAWN_EGG", org.bukkit.Material.LEGACY_MONSTER_EGG, "SPAWN EGGS", 383),
    ...
    EXPERIENCE_BOTTLE("EXPERIENCE_BOTTLE", org.bukkit.Material.EXPERIENCE_BOTTLE, "BOTTLES O ENCHANTING", 384, "BOTTLE O ENCHANTING", Arrays.asList("EXP_BOTTLE", "XP", "EXP", "BOTTLED_EXP", "BOTTLED_XP", "BOTTLED_EXPERIENCE")),
    FIRE_CHARGE("FIRE_CHARGE", org.bukkit.Material.FIRE_CHARGE, "FIRE CHARGES", 385, Collections.singletonList("FIREBALL")),
    WRITABLE_BOOK("WRITABLE_BOOK", org.bukkit.Material.WRITABLE_BOOK, "BOOKS AND QUILLS", 386, "BOOK AND QUILL", Collections.singletonList("BOOK_AND_QUILL")),
    ...
    FLOWER_POT("FLOWER_POT", org.bukkit.Material.FLOWER_POT, "FLOWER POTS", 390, Collections.singletonList("FLOWER_POT_ITEM")),
    CARROT("CARROT", org.bukkit.Material.CARROT, "CARROTS", 391, Collections.singletonList("CARROT_ITEM")),
    POTATO("POTATO", org.bukkit.Material.POTATO, "POTATOES", 392, Collections.singletonList("POTATO_ITEM")),
    ...
    MAP("MAP", org.bukkit.Material.MAP, "MAPS", 395, Collections.singletonList("EMPTY_MAP")),
    GOLDEN_CARROT("GOLDEN_CARROT", org.bukkit.Material.GOLDEN_CARROT, "GOLDEN CARROTS", 396, Collections.singletonList("GOLD_CARROT")),
    SKELETON_SKULL("SKELETON_SKULL", org.bukkit.Material.SKELETON_SKULL, "SKELETON SKULLS", 397, Collections.singletonList("SKELETON_HEAD")),
    WITHER_SKELETON_SKULL("WITHER_SKELETON_SKULL", org.bukkit.Material.WITHER_SKELETON_SKULL, "WITHER SKELETON SKULLS", 397, Arrays.asList("WITHER_SKELETON_HEAD", "WITHER_SKULL", "WITHER_HEAD")),
    ZOMBIE_HEAD("ZOMBIE_HEAD", org.bukkit.Material.ZOMBIE_HEAD, "ZOMBIE HEADS", 397, Collections.singletonList("ZOMBIE_SKULL")),
    HEAD("HEAD", org.bukkit.Material.PLAYER_HEAD, "HEADS", 397, Collections.singletonList("SKULL")),
    CREEPER_HEAD("CREEPER_HEAD", org.bukkit.Material.CREEPER_HEAD, "CREEPER HEADS", 397, Collections.singletonList("CREEPER_SKULL")),
    CARROT_ON_A_STICK("CARROT_ON_A_STICK", org.bukkit.Material.CARROT_ON_A_STICK, 398, Collections.singletonList("CARROT_STICK")),
    ...
    FIREWORKS("FIREWORKS", org.bukkit.Material.FIREWORK_ROCKET, "FIREWORKS", 401, "FIREWORK ROCKET", Arrays.asList("FIREWORK_ROCKET", "FIREWORK")),
    FIREWORK_CHARGE("FIREWORK_CHARGE", org.bukkit.Material.FIREWORK_STAR, 402, Collections.singletonList("FIREWORK_STAR")),
    ENCHANTED_BOOK("ENCHANTED_BOOK", org.bukkit.Material.ENCHANTED_BOOK, "ENCHANTED BOOKS", 403),
    COMPARATOR("COMPARATOR", org.bukkit.Material.COMPARATOR, "REDSTONE COMPARATORS", 404, "REDSTONE COMPARATOR", Collections.singletonList("REDSTONE_COMPARATOR")),
    NETHERBRICK("NETHERBRICK", org.bukkit.Material.NETHER_BRICKS, "NETHER BRICKS", 405, "NETHER BRICK", Collections.singletonList("NETHER_BRICK_ITEM")),
    QUARTZ("QUARTZ", org.bukkit.Material.QUARTZ, 406, "NETHER QUARTZ", Collections.singletonList("NETHER_QUARTZ")),
    TNT_MINECART("TNT_MINECART", org.bukkit.Material.TNT_MINECART, "MINECARTS WITH TNT", 407, "MINECART WITH TNT", Arrays.asList("MINECART_WITH_TNT", "EXPLOSIVE_MINECART")),
    ...
    IRON_HORSE_ARMOR("IRON_HORSE_ARMOR", org.bukkit.Material.IRON_HORSE_ARMOR, 417, Collections.singletonList("IRON_BARDING")),
    GOLDEN_HORSE_ARMOR("GOLDEN_HORSE_ARMOR", org.bukkit.Material.GOLDEN_HORSE_ARMOR, 418, Arrays.asList("GOLD_HORSE_ARMOR", "GOLD_BARDING", "GOLDEN_BARDING")),
    DIAMOND_HORSE_ARMOR("DIAMOND_HORSE_ARMOR", org.bukkit.Material.DIAMOND_HORSE_ARMOR, 419, Collections.singletonList("DIAMOND_BARDING")),
    LEAD("LEAD", org.bukkit.Material.LEAD, "LEADS", 420, Collections.singletonList("LEASH")),
    NAME_TAG("NAME_TAG", org.bukkit.Material.NAME_TAG, "NAME TAGS", 421),
    COMMAND_BLOCK_MINECART("COMMAND_BLOCK_MINECART", org.bukkit.Material.COMMAND_BLOCK_MINECART, "MINECARTS WITH COMMAND BLOCKS", 422, "MINECART WITH COMMAND BLOCK", Arrays.asList("MINECART_WITH_COMMAND_BLOCK", "COMMAND_IN_MINECART", "MINECART_WITH_COMMAND", "COMMAND_MINECART")),
    ...
    BANNER("BANNER", org.bukkit.Material.LEGACY_BANNER, "BANNERS", 425),
    ...
    SPRUCE_DOOR("SPRUCE_DOOR", org.bukkit.Material.SPRUCE_DOOR, "SPRUCE DOORS", 427, Arrays.asList("SPRUCE_WOOD_DOOR", "SPRUCE_DOOR_ITEM")),
    BIRCH_DOOR("BIRCH_DOOR", org.bukkit.Material.BIRCH_DOOR, "BIRCH DOORS", 428, Arrays.asList("BIRCH_WOOD_DOOR", "BIRCH_DOOR_ITEM")),
    JUNGLE_DOOR("JUNGLE_DOOR", org.bukkit.Material.JUNGLE_DOOR, "JUNGLE DOORS", 429, Arrays.asList("JUNGLE_WOOD_DOOR", "JUNGLE_DOOR_ITEM")),
    ACACIA_DOOR("ACACIA_DOOR", org.bukkit.Material.ACACIA_DOOR, "ACACIA DOORS", 430, Arrays.asList("ACACIA_WOOD_DOOR", "ACACIA_DOOR_ITEM")),
    DARK_OAK_DOOR("DARK_OAK_DOOR", org.bukkit.Material.DARK_OAK_DOOR, "DARK OAK DOORS", 431, Arrays.asList("DARK_OAK_WOOD_DOOR", "DARK_OAK_DOOR_ITEM")),
    CHORUS_FRUIT("CHORUS_FRUIT", org.bukkit.Material.CHORUS_FRUIT, 432),
    CHORUS_FRUIT_POPPED("CHORUS_FRUIT_POPPED", org.bukkit.Material.POPPED_CHORUS_FRUIT, 433, "POPPED CHORUS FRUIT", Collections.singletonList("POPPED_CHORUS_FRUIT")),
    ...
    DRAGON_BREATH("DRAGON_BREATH", org.bukkit.Material.DRAGON_BREATH, 437, Collections.singletonList("DRAGONS_BREATH")),
    ...
    SPRUCE_BOAT("SPRUCE_BOAT", org.bukkit.Material.SPRUCE_BOAT, "SPRUCE BOATS", 444, Arrays.asList("SPRUCE_WOOD_BOAT", "BOAT_SPRUCE")),
    BIRCH_BOAT("BIRCH_BOAT", org.bukkit.Material.BIRCH_BOAT, "BIRCH BOATS", 445, Arrays.asList("BIRCH_WOOD_BOAT", "BOAT_BIRCH")),
    JUNGLE_BOAT("JUNGLE_BOAT", org.bukkit.Material.JUNGLE_BOAT, "JUNGLE BOATS", 446, Arrays.asList("JUNGLE_WOOD_BOAT", "BOAT_JUNGLE")),
    ACACIA_BOAT("ACACIA_BOAT", org.bukkit.Material.ACACIA_BOAT, "ACACIA BOATS", 447, Arrays.asList("ACACIA_WOOD_BOAT", "BOAT_ACACIA")),
    DARK_OAK_BOAT("DARK_OAK_BOAT", org.bukkit.Material.DARK_OAK_BOAT, "DARK OAK BOATS", 448, Arrays.asList("DARK_OAK_WOOD_BOAT", "BOAT_DARK_OAK")),
    TOTEM_OF_UNDYING("TOTEM_OF_UNDYING", org.bukkit.Material.TOTEM_OF_UNDYING, "TOTEMS OF UNDYING", 449, Collections.singletonList("TOTEM")),
    ...
    //Music Discs
    RECORD_13("RECORD_13", org.bukkit.Material.MUSIC_DISC_13, 2256, "C418 - 13", Arrays.asList("13", "MUSIC_DISC_13", "MUSIC_13", "C418_13", "GOLD_RECORD")),
    RECORD_CAT("RECORD_CAT", org.bukkit.Material.MUSIC_DISC_CAT, 2257, "C418 - CAT", Arrays.asList("CAT", "MUSIC_DISC_CAT", "MUSIC_CAT", "C418_CAT", "GREEN_RECORD")),
    RECORD_BLOCKS("RECORD_BLOCKS", org.bukkit.Material.MUSIC_DISC_BLOCKS, 2258, "C418 - BLOCKS", Arrays.asList("BLOCKS", "MUSIC_DISC_BLOCKS", "MUSIC_BLOCKS", "C418_BLOCKS", "RECORD_3")),
    RECORD_CHIRP("RECORD_CHIRP", org.bukkit.Material.MUSIC_DISC_CHIRP, 2259, "C418 - CHIRP", Arrays.asList("CHIRP", "MUSIC_DISC_CHIRP", "MUSIC_CHIRP", "C418_CHIRP", "RECORD_4")),
    RECORD_FAR("RECORD_FAR", org.bukkit.Material.MUSIC_DISC_FAR, 2260, "C418 - FAR", Arrays.asList("FAR", "MUSIC_DISC_FAR", "MUSIC_FAR", "C418_FAR", "RECORD_5")),
    RECORD_MALL("RECORD_MALL", org.bukkit.Material.MUSIC_DISC_MALL, 2261, "C418 - MALL", Arrays.asList("MALL", "MUSIC_DISC_MALL", "MUSIC_MALL", "C418_MALL", "RECORD_6")),
    RECORD_MELLOHI("RECORD_MELLOHI", org.bukkit.Material.MUSIC_DISC_MELLOHI, 2262, "C418 - MELLOHI", Arrays.asList("MELLOHI", "MUSIC_DISC_MELLOHI", "MUSIC_MELLOHI", "C418_MELLOHI", "RECORD_7")),
    RECORD_STAL("RECORD_STAL", org.bukkit.Material.MUSIC_DISC_STAL, 2263, "C418 - STAL", Arrays.asList("STAL", "MUSIC_DISC_STAL", "MUSIC_STAL", "C418_STAL", "RECORD_8")),
    RECORD_STRAD("RECORD_STRAD", org.bukkit.Material.MUSIC_DISC_STRAD, 2264, "C418 - STRAD", Arrays.asList("STRAD", "MUSIC_DISC_STRAD", "MUSIC_STRAD", "C418_STRAD", "RECORD_9")),
    RECORD_WARD("RECORD_WARD", org.bukkit.Material.MUSIC_DISC_WARD, 2265, "C418 - WARD", Arrays.asList("WARD", "MUSIC_DISC_WARD", "MUSIC_WARD", "C418_WARD", "RECORD_10")),
    RECORD_11("RECORD_11", org.bukkit.Material.MUSIC_DISC_11, 2266, "C418 - 11", Arrays.asList("11", "MUSIC_DISC_11", "MUSIC_11", "C418_11")),
    RECORD_WAIT("RECORD_WAIT", org.bukkit.Material.MUSIC_DISC_WAIT, 2267, "C418 - WAIT", Arrays.asList("WAIT", "MUSIC_DISC_WAIT", "MUSIC_WAIT", "C418_WAIT", "RECORD_12"));
